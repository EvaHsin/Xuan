...
with col1:
    st.markdown(f"**熱量**<br>{daily_total['熱量']:.1f} / 2000 kcal", unsafe_allow_html=True)
with col2:
    st.markdown(f"**蛋白質**<br>{daily_total['蛋白質']:.1f} / 130 g", unsafe_allow_html=True)
with col3:
    st.markdown(f"**碳水**<br>{daily_total['碳水']:.1f} / 250 g", unsafe_allow_html=True)
with col4:
    st.markdown(f"**油脂**<br>{daily_total['油脂']:.1f} / 55 g", unsafe_allow_html=True)
